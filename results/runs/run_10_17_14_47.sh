...
#SBATCH --job-name=job_run_10_17_14_47
#SBATCH --output=/private/home/dejang/tools/cg_rllib_slurm/results/runs/run_10_17_14_47.log
#SBATCH --error=/private/home/dejang/tools/cg_rllib_slurm/results/runs/run_10_17_14_47.err
...
python -u main_ecg.py --slurm --iter=2 --sweep=0
echo "SUCCESS"
