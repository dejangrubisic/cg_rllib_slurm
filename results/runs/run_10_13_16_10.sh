...
#SBATCH --job-name=job_run_10_13_16_10
#SBATCH --output=/private/home/dejang/tools/cg_rllib_slurm/results/runs/run_10_13_16_10.log
#SBATCH --error=/private/home/dejang/tools/cg_rllib_slurm/results/runs/run_10_13_16_10.err
...
python -u main.py --slurm --iter=2 --sweep=0
echo "SUCCESS"
